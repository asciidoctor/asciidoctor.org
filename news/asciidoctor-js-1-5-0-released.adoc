...
We recommend that you browse the https://opalrb.com/docs/using_ruby_from_javascript[Opal documentation] to learn how method names are mapped and what data types it expects.
