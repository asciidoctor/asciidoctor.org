...
image::bower-logo-small.png[Bower,100,88,role=right]
...
{uri-asciidoc-preview-atom}[asciidoc-preview (Atom Editor)]:: A plugin that shows you a preview of your document while you type!
