...
Asciidoctor recognizes text between "`air quotes`" as a quote block.
...
This syntax is inspired by the gesture people make with their fingers when quoting someone, such as famously used by http://knowyourmeme.com/memes/dr-evil-air-quotes[Dr. Evil].
