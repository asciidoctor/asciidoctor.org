...
:ruby-api-ref: http://asciidoctor.org/rdoc/Asciidoctor.html 
...
If a quote block does not have an attribution, the empty attribution div is no longer displayed in the HTML5 output.
...
* The Asciidoctor CLI no longer splits attribute key/value pairs on the first equal sign. Resolves issue {issue-ref}/291[291]
