...
image::github-history.png[Revision history in GitHub, 360, 270, link="https://github.com/asciidoctor/asciidoctor.org/commits/develop/docs/asciidoc-syntax-quick-reference.adoc", role="center"]
