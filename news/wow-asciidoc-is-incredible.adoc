...
My interest in AsciiDoc, and even the origins of Asciidoctor, can be traced back to this post.
So we don't lose that history, I've decided to preserve it here on the Asciidoctor blog.
