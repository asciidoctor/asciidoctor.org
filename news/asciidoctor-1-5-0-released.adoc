...
Best of all, {uri-github}/graphitefriction[Sarah] has been hard at work filling in Asciidoctor's own {uri-manual}[user manual] and helping teams understand how to http://graphitefriction.com/decks[write better documentation^].
