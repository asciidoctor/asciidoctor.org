= Asciidoctor 1.5.0 (_Bleeding Heart_) released!
Dan Allen <https://github.com/mojavelinux[@mojavelinux]>; Sarah White <https://github.com/graphitefriction[@graphitefriction]>
2014-08-06
:revdate: 2014-08-06 05:43:31 -0600
:page-tags: [release]
:page-draft:
:compat-mode!:
...
Refer to {uri-migrate}[the migration guide] for information about the affected syntax and to learn how to prepare your content for migrating.
...
Asciidoctor is now in use by even more open source projects, including Groovy, GroovyFX, Griffon, Infinispan, Weld, Hibernate OGM, Spring Data and git-scm.com, as well as NFJS, the Magazine.
