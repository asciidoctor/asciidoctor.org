...
Hopefully, by the end, you'll look back in amazement about how natural it felt.
...
In AsciiDoc, the bulk of document is paragraph content, which you may embellish with mild and intuitive semantic markup.
In fact, all it takes to create a document in AsciiDoc is one or more paragraphs.
...
To start a new paragraph, just hit Enter twice and continue typing.
....
...
Although the file extension doesn't matter when running the file through an AsciiDoc processor, it's used in other contexts (such as by your editor or GitHub) to indicate it's an AsciiDoc document.
...
NOTE: The double punctuation applies for all types of quoted text except smart quotes.
