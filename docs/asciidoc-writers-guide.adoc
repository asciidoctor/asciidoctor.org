...
include::{includedir}/dlist.adoc[tags=label]

==== Hybrid lists

include::{includedir}/dlist.adoc[tags=hybrid]
...
Consult the {asciidoc-guide-ref}#X98[block audio and video macros] section of the AsciiDoc User Guide for details.
