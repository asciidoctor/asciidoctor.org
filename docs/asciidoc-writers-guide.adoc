...
_Writing, on the other hand, rarely feels so easy._
...
With an understanding of what AsciiDoc is and why it's (so desperately) needed, we'll delve into the AsciiDoc syntax.
