...
In contrast, description lists--also called variable or term-definition lists--are a collection of descriptions that each have supporting content and they are rarely nested.
...
include::{includedir}/o-list-nest.adoc[tag=basic]
...
include::{includedir}/dlist.adoc[tag=description]

==== Hybrid lists

include::{includedir}/dlist.adoc[tag=hybrid]
...
include::{includedir}/url.adoc[tag=basic]

include::{includedir}/url.adoc[tag=link]

==== Target window and role attributes for links

include::{includedir}/url.adoc[tag=attr]
