...
|Asciidoctor
|A converter for Asciidoctor that allows you to convert an AsciiDoc document into the fodt (plain Open Document) format.
...
ASCIIDOCTOR INTERACTUA CON MERMAID, GENERANDO AUTODIAGRAMAS PARA EDITAR Y VER AL INSTANTE EN EL NAVEGADOR, Y AGREGAR DOCUMENTACION DEL DIAGRAMA QUE QUIERAS HACER, PARA FACILITAR SU USO, GRACIAS
