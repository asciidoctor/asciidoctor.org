...
|https://launchpad.net/imagemap-block-processor[HTML Image Maps]
|Asciidoctor
|An asciidoctor extension that generates a html imagemap. The pre-defined areas on the image can point to chapters in the document. Feedbacks, proposals are highly appreciated.
|====
