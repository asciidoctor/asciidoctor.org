...
|https://github.com/diguage/asciidoctor-comment-links[Asciidoctor Comment Links^]
|Asciidoctor
|An asciidoctor extension that turn a link in the comment of the source block into a clickable jump link.
|====
