...
Using the EPUB3 publication as the _digital master_, {project-name} can then produce a KF8/MOBI, the file format required by Amazon Kindle.
...
If you don't already have an AsciiDoc document, you can use the [file]_sample-book.adoc_ file and its chapters found in the [path]_data/samples_ directory of the repository.
