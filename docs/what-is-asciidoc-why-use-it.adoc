...
- add point about no lock-in: "Here's the awesome thing about #asciidoc. Worse case scenario, you can drop in to DocBook for interchange. No need to invent another format! DocBook is also the "no lock-in" out for #asciidoc. You decide AsciiDoc doesn't work for you, you can bail on it w/o losing a word."
////
