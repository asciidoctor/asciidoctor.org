...
- http://docs.jboss.org/cdi/spec/1.1/cdi-spec.html[Context and Dependency Injection for Java EE Specification] (https://github.com/cdi-spec/cdi/tree/master/spec[AsciiDoc source])
...
- http://enterprisewebbook.com[Enterprise Web Book] (https://github.com/Farata/EnterpriseWebBook[AsciiDoc source])
