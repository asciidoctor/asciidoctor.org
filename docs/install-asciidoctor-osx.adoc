...
Install git, using either Homebrew (as described above) or the http://git-scm.com/download/mac[installer for macOS].
...
https://brew.sh[Homebrew] is "`the missing package manager for macOS.`" Homebrew installs the stuff you need that Apple didn't.
