...
Tables can also be populated using data formatted as delimiter-separated values (i.e., data tables).
...
Well, it really depends on who you consult.
...
CSV is the more common data format.
****
