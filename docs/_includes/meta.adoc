...
==== Title
// tag::atitle[]
By default, {adr} sets the HTML `<title>` tag value to the text of the document title.
However, you can override this behaviour by setting the `title` attribute in the document's header.
// end::atitle[]
