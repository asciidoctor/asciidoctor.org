...
The value of the `idseparator` must be _exactly one valid ID character._
...
These settings are designed so the IDs that GitHub generates align with the IDs Asciidoctor generates.
