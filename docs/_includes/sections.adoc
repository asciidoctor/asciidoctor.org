...
=== Custom IDs
// tag::custom-id[]
Like with on every components (see <<anchordef>>) you can define a custom ID for your section header.
This can be useful when you define a cross reference pointing to this section.
