...
A table can be printed sideways using the 'orientation' attribute or the 'rotate' option:
...
Currently, this is only implemented by the Docbook backend (it sets 'orient="land"').
