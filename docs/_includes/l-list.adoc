...
[source]
----
include::ex-l-list.adoc[tags=base]
----
...
[source]
----
include::ex-l-list.adoc[tags=base-horz]
----
...
[source]
----
include::ex-l-list.adoc[tags=base-mix]
----
...
[source]
----
include::ex-l-list.adoc[tags=base-mix-alt]
----
...
[source]
----
include::ex-l-list.adoc[tags=3-mix]
----
