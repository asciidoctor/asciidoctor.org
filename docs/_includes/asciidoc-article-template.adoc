...
[[id-for-literal-block]]
.Literal block title
....
Literal blocks are commonly used to simulate output produced by a terminal.
Literal block content is subject to verbatim substitutions.
....
