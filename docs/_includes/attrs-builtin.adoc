...
|chapter-label
|Sets the prefix added to chapter titles (i.e., level-1 section titles when doctype is book). _(pdf converter only)_
|Chapter
|_any_
|
...
|_empty_ (alias for AMS), AMS, all, none
|{y}
...
|_empty_, collection of Google Fonts
|{y}
