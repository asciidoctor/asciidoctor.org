...
Since attributes can reference other attributes, it would be possible to create an output document that is disproportionately larger than the input document without this limit in place.
