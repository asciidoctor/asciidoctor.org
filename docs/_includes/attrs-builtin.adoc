...
See <<asciidoctor-vs-asciidoc,Migrating from AsciiDoc Python>> if you are updating an older document.
...
|
|<<asciidoctor-vs-asciidoc,Migrating from AsciiDoc Python>>
