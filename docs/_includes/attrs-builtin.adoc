...
|chapter-caption
|Sets the prefix added to chapter titles (i.e., level-1 section titles when doctype is book) in cross reference text.
|Chapter
|_any_
|
...
|section-caption
|Sets the prefix added to section titles in cross reference text.
|Section
|_any_
|
|<<book-parts-and-chapters>>, <<sections>>, <<customizing-labels>>
...
|full, short, or basic
|{y}
|<<customizing-the-cross-reference>>
