...
=== Manual placement
// tag::place[]
`toc` values of `auto`, `preamble`, and `macro` place the TOC in the body of the document.
...
To place the TOC anywhere else in your document, set the `toc` attribute to `macro`.
