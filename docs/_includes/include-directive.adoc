...
To fix the problem, edit the file path and run the converter again. If you want Asciidoctor not to trigger a warning and
drop the include when the file can't be found add the opts=optional attribute to the include directive.
