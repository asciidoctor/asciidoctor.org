ifndef::includedir[= AsciiDoc vs Markdown]
////
...
NOTE: Certain Markdown flavors, such as Markdown Extra, support additional features such as tables and definition lists.
