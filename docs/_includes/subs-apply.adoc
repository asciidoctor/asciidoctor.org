...
You can add or remove a substitution from the default substitution list using the `+` and `-` modifiers.
...
For example, here's how you would add the attributes substitution to a listing block's default substitution list.
