...
* biblographical information of the book, speech, play, poem, etc., where the content was drawn from
* excerpt text
// end::intro[]
...
[source]
----
include::ex-quote.adoc[tags=para2-c]
----
...
.Rendered quote paragraph
[source]
----
include::ex-quote.adoc[tags=para2]
----

If the quote or excerpt is more than one paragraph, place the text between delimiter lines consisting of four underscores (+{underscore}{underscore}{underscore}{underscore}+).

.Quote block
[source]
----
include::ex-quote.adoc[tags=comp]
----
