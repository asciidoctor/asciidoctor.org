...
However, you can forgo this change to the syntax by setting the `compat-mode` attribute to `legacy` either in the document header:
...
* \`Use {asciidoctor-version} to print the version of Asciidoctor` (attribute is _not_ replaced)
* +The version of Asciidoctor is {asciidoctor-version}+ (attribute _is_ replaced)
...
* [x-]\`Use {asciidoctor-version} to print the version of Asciidoctor` (attribute is _not_ replaced)
* [x-]+The version of Asciidoctor is {asciidoctor-version}+ (attribute _is_ replaced)
