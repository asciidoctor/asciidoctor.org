...
****
You might notice that the attribute is based on the term "`source highlighter`", yet the library that performs the highlighting is referred to as a "`syntax highlighter`".
