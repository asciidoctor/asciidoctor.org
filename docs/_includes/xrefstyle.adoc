...
* `chapter-refsig` - reference signifier for a chapter (default: Chapter)
* `section-refsig` - reference signifier for a section (default: Section)
* `appendix-refsig` - reference signifier for an appendix (default: Appendix)
