...
In order to be able to use the *full* or the *short* style, the `*-caption` attributes needs to be set (`listing-caption` for listings,` example-caption` for examples or `table-caption` for tables), otherwise the *basic* style is used.
