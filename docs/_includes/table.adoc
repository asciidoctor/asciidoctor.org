...
Each row must share the same number of cells, taking into account any <<user-manual#cell-specifiers,column or row spans>>.
...
[source]
----
include::ex-base-table.adoc[tags=base-co]
----
...
include::ex-base-table.adoc[tags=base-alt]
...
[source]
----
include::ex-base-table.adoc[tags=cell1]
----
...
[source]
----
include::ex-base-table.adoc[tags=cell2]
----
...
[source]
----
include::ex-base-table.adoc[tags=same]
----
...
----
<1> The +cols+ attribute states that this table has three columns. The +*+ is a repeat operator which is explained in the <<user-manual#column-specifiers,column specifiers>> section.
...
[source]
----
include::ex-base-table.adoc[tags=same-indv]
----
