...
http://opalrb.org[Opal] is used to transcompile the code from Ruby to JavaScript to make {uri-asciidoctorjs}[Asciidoctor.js], which can be used whereever JavaScript runs, such as in a web browser or on Node.js.
