...
----
include::ex-xref.adoc[tags=block-id-brackets]
----
...
----
include::ex-xref.adoc[tags=block-id-shorthand]
----
...
----
include::ex-xref.adoc[tags=anchor-shorthand]
----
...
----
include::ex-xref.adoc[tags=anchor-header-extra]
----
