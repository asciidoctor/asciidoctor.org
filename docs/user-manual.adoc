...
include::{includedir}/attr-env.adoc[]
////
...
This appendix catalogs all the known document attributes in Asciidoctor.
This list includes environment, built-in and predefined (aka character reference) attributes.
Authors may define additional attributes for their own purposes.

include::{includedir}/attr-env.adoc[leveloffset=1]
