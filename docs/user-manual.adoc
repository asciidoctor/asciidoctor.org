...
:asciidoctor-pdf-docs-ref: https://github.com/asciidoctor/asciidoctor-pdf/blob/master/README.adoc
...
PDF output is made possible by a number of tools.

fopub Tool::
  Directions for using the tool are documented in the {fopub-doc-ref}[asciidoctor-fopub README].
asciidoctor-pdf Tool::
  Directions for using the tool are documented in the {asciidoctor-pdf-docs-ref}[asciidoctor-pdf README].
