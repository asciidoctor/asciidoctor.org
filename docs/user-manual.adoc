...
include::{includedir}/para-align.adoc[]
...
=== Using an Include with List Content

include::{includedir}/include-list-content.adoc[]
...
include::{includedir}/src-rouge.adoc[]
...
include::{includedir}/exten-block-compound.adoc[]
