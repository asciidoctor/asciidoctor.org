...
:asciimath-uri: http://www1.chapman.edu/~jipsen/mathml/asciimath.html
:latexmath-uri: https://www.maths.nottingham.ac.uk/personal/drw/lm.html
:mathjax-uri: http://www.mathjax.org
...
Asciidoctor implements additional syntax, attributes and functions that the AsciiDoc.py processor can not handle.
...
[cols="1,1m,1m,3,1"]
|===
|Style |Style Name |Delimiter |Purpose |Substitutions
...
|$$[stem]$$
|$$++++$$
|Unprocessed content that is sent directly to an interpreter (such as AsciiMath or LaTeXMath)
|None
////

This table shows the substitutions performed by each substitution group referenced in the previous table.

include::{includedir}/subs-group-table.adoc[]
...
include::{includedir}/hr.adoc[tags=hr-a]

=== Markdown-style horizontal rules

include::{includedir}/hr.adoc[tags=hr-md]
...
include::{includedir}/image-position-intro.adoc[]

==== Positioning attributes

include::{includedir}/image-position-attr.adoc[]

==== Positioning roles

include::{includedir}/image-position-role.adoc[]

==== Framing roles

include::{includedir}/image-position-frame.adoc[]

==== Control the float

include::{includedir}/image-position-float.adoc[]
...
include::{includedir}/quote-abbr.adoc[]
...
include::{includedir}/quote-md.adoc[]
