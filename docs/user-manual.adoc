...
include::{includedir}/asciidoc-vs-markdown.adoc[]
...
// Better blank than 'under construction'?
...
If you want to incorporate your Javadoc into another document instead, there is an experimental doclet that exports them to `.adoc` files: see 
https://github.com/johncarl81/exportdoclet
and 
http://discuss.asciidoctor.org/Export-Javadoc-strings-td4172.html.
...
{uri-org}/asciidoctor.js[Asciidoctor.js] is a JavaScript port of Asciidoctor. 
With asciidoctor.js, the AsciiDoc syntax can be used in the browser!
...
{adr} accepts a lot of Markdown syntax, see {uri-home}/docs/asciidoc-syntax-quick-reference/#markdown-compatibility[Markdown Compatibility], so you can make changes  gradually.
The syntax that must be changed is listed in <<md_vs_adr>>.
