...
include::{includedir}/install-upgrade-asciidoctor.adoc[lines=10..21]

== Installing the Asciidoctor Ruby Gem

include::{includedir}/install-upgrade-asciidoctor.adoc[lines=25..32]
 
=== Install with Bundler

include::{includedir}/install-upgrade-asciidoctor.adoc[lines=36..48]

=== Install with +yum+
 
include::{includedir}/install-upgrade-asciidoctor.adoc[lines=52..59]

=== Install with +apt-get+
 
include::{includedir}/install-upgrade-asciidoctor.adoc[lines=63..70]

== Upgrading the Asciidoctor Ruby Gem

include::{includedir}/install-upgrade-asciidoctor.adoc[lines=74..99]
...
----
include::{includedir}/toc-right.adoc[]
----

.Result: Assigning the +right+ value to +toc+
====
image::toc-right.png[Table of contents using right value]
====
...
The +specialcharacters+ element searches for three characters (+<+, +>+, +&+) and replaces them with their character entity references.
...
NOTE: *Examples and more information are pending.*
...
When your document is processed, the backslash is removed.
