...
If you want to setup this environment using Chrome or Firefox, you can try out the https://github.com/guard/guard-livereload[Guard::LiveReload plugin] and the companion LiveReload extension for https://chrome.google.com/webstore/detail/livereload/jnihajbhpnppcggbcgedagnkighmdlei?hl=en[Chrome] or http://feedback.livereload.com/knowledgebase/articles/86242-how-do-i-install-and-use-the-browser-extensions-[Firefox]. If haven't been able to get LiveReload to work yet, but it sounds promising.
