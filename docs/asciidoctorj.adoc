...
:dagger: &#8224;
// URIs:
ifdef::env-site[:uri-docs: link:/docs]
ifndef::env-site[:uri-docs: http://asciidoctor.org/docs]
...
image:https://img.shields.io/badge/javadoc.io-1.5.4-blue.svg[Javadoc, link=http://www.javadoc.io/doc/org.asciidoctor/asciidoctorj/1.5.4]
endif::[]
...
To start using it under WildFly AS, you can't just use it, you also have to _modify your WildFly installation_
due to classpath loading issues; see <<wildfly-kludge>>.
...
This object represents the whole document, including its headings.
...
If you want to use AsciidoctorJ in an application deployed on [app]_WildFly AS_, you have to install AsciidoctorJ as a JBoss Module.
