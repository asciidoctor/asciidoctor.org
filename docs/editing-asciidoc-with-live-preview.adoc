...
Here's an overview of the different ways to setup live preview of AsciiDocsssssssssss.
...
Next, launch Visual Studio Code and open the Quick Open dialog by pressing kbd:[Ctrl,P].
Then, type the following to locate and install the AsciiDoc extension (by João Pinto):
