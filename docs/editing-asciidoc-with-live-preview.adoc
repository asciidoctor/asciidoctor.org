...
Asciidoc Image Helper package:: provides the ability to paste images from the clipboard
Autocomplete Asciidoc package:: automatically completes Asciidoc language items
Asciidoc Assistant package:: Installs useful components to Atom for editing Asciidoc files (including the above packages)
...
* https://github.com/asciidoctor/atom-autocomplete-asciidoc[Asciidoc language autocomplete]
* https://atom.io/packages/asciidoc-assistant[Asciidoc assistant package]
