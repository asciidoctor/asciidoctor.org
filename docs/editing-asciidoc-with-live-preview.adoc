...
:uri-eclipse-asciidoctor-editor-plugin: https://github.com/de-jcup/eclipse-asciidoctor-editor
:experimental:
:page-layout: docs
:imagesdir: ../images
ifndef::env-site[]
...
Install the community plugin {uri-eclipse-asciidoctor-editor-plugin}[`Asciidoctor Editor`].
