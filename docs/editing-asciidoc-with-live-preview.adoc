...
Install https://workingcopy.app/[Working Copy] on your iPhone or iPad.
Switch between editing AsciiDoc files and preview rendering with the mode switcher in the upper right corner.
