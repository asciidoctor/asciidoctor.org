...
Install the open source plugin `AsciiDoctor Editor` from 
{uri-eclipse-plugin-marketplace}[Eclipse Marketplace] 
or visit project site at {uri-eclipse-plugin-github}[GitHub].
