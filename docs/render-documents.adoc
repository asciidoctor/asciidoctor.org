...
If you prefer to embed the stylesheet into the document, include the +linkcss!+ attribute to the rendering argument.
...
A stable of attributes are also available to add of feature and style customizations to the rendered HTML.
