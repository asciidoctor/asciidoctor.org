...
What is the MIME Type for Asciidoc, since we usually have 4 extensions (.adoc, .asciidoc, .ad, .asc)?::
Following this discussion(http://discuss.asciidoctor.org/Mimetype-for-Asciidoc-td211.html[Mimetype for Asciidoc]) , we have:
