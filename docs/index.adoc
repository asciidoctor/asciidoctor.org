...
TIP: Can't find the information you need? Reach out to project members and users via the http://discuss.asciidoctor.org/[discussion list] or the https://webchat.freenode.net/?channels=#asciidoctor[#asciidoctor] channel on Freenode IRC.
