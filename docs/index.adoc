...
Can't find the information you need in the documentation? Reach out to project members and users via the http://discuss.asciidoctor.org/[mailing list] or the Asciidoctor IRC channel at irc.freenode.org/#asciidoctor.

== The Basics

Discover what Asciidoctor and AsciiDoc do and how they can help you. 

What is Asciidoctor, and what does it do? 
// how can it help me?
