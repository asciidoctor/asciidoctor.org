...
image:https://www.netlify.com/img/global/badges/netlify-dark.svg[Deploy Status, link={uri-netlify-deploys}]
endif::[]

This is the project site for the https://asciidoctor.org[Asciidoctor] project.
The site is composed in AsciiDoc, styled by https://foundation.zurb.com/sites/docs/v/4.3.2[Foundation 4], baked with http://awestruct.org/[Awestruct], and hosted by https://www.netlify.com/[Netlify].
